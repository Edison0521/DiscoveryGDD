"""
Sampling Subgraphs with Guaranteed Treewidth for Accurate and Efficient
Graphical Inference (WSDM 2020)

Authors:
- Jaemin Yoo (jaeminyoo@snu.ac.kr), Seoul National University
- U Kang (ukang@snu.ac.kr), Seoul National University
- Mauro Scanagatta (mscanagatta@fbk.eu), Fondazione Bruno Kessler
- Giorgio Conrani (giorgio@idsia.ch), IDSIA
- Marco Zaffalon (zaffalon@idsia.ch), IDSIA
...
@click.command()
@click.argument('edges', default='/user_data/zhangyd/1DBLP/yago/running/pro_threshold_1000/resource/edges.csv')
@click.argument('labels', default='/user_data/zhangyd/1DBLP/yago/running/pro_threshold_1000/resource/nodes.csv')
@click.option('--bound', default=8, type=int)
@click.option('--divider', default=256, type=int)
@click.option('--num-folds', default=8, type=int)
@click.option('--rand-seed', default=4, type=int)
@click.option('--save-dir', default='../output', type=str)
